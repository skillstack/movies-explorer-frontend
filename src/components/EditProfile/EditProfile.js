        ...
        <section className="edit-profile">
          ...
          >
            <label className="edit-profile__field">
              Имя
              <input
                className={errors.name ? "edit-profile__input edit-profile__input_type_error" : "edit-profile__input"}
                id="name-input"
                name="name"
                type="text"
            ...
            <label className="edit-profile__field">
              E-mail
              <input
                className={errors.email ? "edit-profile__input edit-profile__input_type_error" : "edit-profile__input"}
                id="email-input"
                name="email"
                type="text"
